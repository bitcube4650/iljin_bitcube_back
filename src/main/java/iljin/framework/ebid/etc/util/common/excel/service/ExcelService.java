...
//		if("02".equals(userInterrelatedCustCode)) {
			excelUtils.downLoadBidCompleteList(userInterrelatedCustCode, param, "downLoad", response);
//		} else {
//			excelUtils.downLoadBidCompleteList("BidHistoryExcelDto", param, "downLoad", response);
//		}
	}
