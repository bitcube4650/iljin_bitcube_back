...
public final class ExcelUtils implements ExcelSupport {
	...
	//통계>>입찰이력
	public void downLoadBidCompleteList(String interrelatedCustCode, Map<String, Object> param, String fileName, HttpServletResponse response) {
		try (SXSSFWorkbook workbook = new SXSSFWorkbook()) {
			List<String> headerNames = new ArrayList<String>();
			if(interrelatedCustCode.equals("02")) {
				headerNames.add("입찰번호");
				headerNames.add("사업부");
				headerNames.add("공정");
				headerNames.add("분류");
				headerNames.add("공장동");
				...
				headerNames.add("호기");
				headerNames.add("입찰명");
				headerNames.add("예산금액");
				headerNames.add("낙찰금액");
				headerNames.add("낙찰사");
				headerNames.add("제출시작일");
				headerNames.add("제출마감일");
				headerNames.add("입찰담당자");
				headerNames.add("회사명");
				headerNames.add("투찰가");
				headerNames.add("투찰시간");
			}else {
				headerNames.add("입찰번호");
				headerNames.add("입찰명");
				headerNames.add("예산금액");
			...
			concreteBidCompleteList.getWorkBookPaging(interrelatedCustCode, workbook, headerNames, param);
